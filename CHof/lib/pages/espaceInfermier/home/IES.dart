...
class _IesState extends State<Ies> {
  ...
  void initState() {
    ...
    _liveList = LiveList(apiConsumer: apiConsumer);// Initialiser LiveList ici
    _fetchData();
  }
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return liveComponent(live:  _liveList.thisWeekLives[index],isDarkMode: CardiInf.isDarkMode.value);
                        },
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return liveComponent(live:  _yourLives[index],isDarkMode: CardiInf.isDarkMode.value);
                        },
                      ),
                    ),
                    const SizedBox(height: 20),
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return liveComponent(live: _liveList.allLives[index],isDarkMode: CardiInf.isDarkMode.value);
                        },
                      ),
                    ),
                  ],
