            ...
            ...foods.map((food) {
              ...
              switch (food.type) {
                case FoodType.FastFood:
                  foodWidget = Image.asset('assets/images/fastfood.png',
                      height: 37, width: 37);
                  break;
                case FoodType.Cigarette:
                  foodWidget = Image.asset('assets/images/cigarettes.png',
                      height: 37, width: 37);
                  break;
                case FoodType.Vegetable:
                  foodWidget = Image.asset('assets/images/vegetable.png',
                      height: 37, width: 37);
                  break;
                case FoodType.Fruit:
                  foodWidget = Image.asset('assets/images/fruit.png',
                      height: 37, width: 37);
                  break;
              }
              return Positioned(
